Feature: world time Viewer App
    ...
    Scenario: Lunch the app and display time in system timezone
        ...
        And the timezone menu should be update and display system timezone
        And the title label should be update and display "The present time in system timezone"
        And the time label should be update and display the current time in system timezone
